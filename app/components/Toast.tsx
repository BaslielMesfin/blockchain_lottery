...
export function Toast() {
  ...
  const displayMsg = isError ? txStatus.replace(/^Error:\s*/, "") : txStatus;
  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-12 md:right-12 z-50">
      <div className="bg-ticket-white text-void-black border-2 border-void-black p-4 shadow-[4px_4px_0px_0px_#000000] flex items-center gap-4 relative max-w-sm">
        ...
        {isSuccess ? (
          <span
            className="material-symbols-outlined text-success-green text-2xl"
        ...
        <div className="flex flex-col">
          <span className="font-label-mono text-xs font-bold uppercase tracking-widest text-void-black">
            {isSuccess ? "Transaction Confirmed" : isError ? "Notice" : "Processing Transaction"}
          </span>
